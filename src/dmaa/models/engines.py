...
vllm_qwen2d5_engine064 = VllmEngine(**{
            ...
            "default_cli_args": " --chat-template dmaa/models/chat_templates/qwen_2d5_add_prefill_chat_template.jinja --max_model_len 16000 --disable-log-stats --enable-auto-tool-choice --tool-call-parser hermes"
})
...
vllm_qwen2d5_72b_engine064 = VllmEngine(**{
             **vllm_engine064.model_dump(),
            "default_cli_args": " --chat-template dmaa/models/chat_templates/qwen_2d5_add_prefill_chat_template.jinja --max_model_len 16000 --disable-log-stats --max_num_seq 10 --enable-auto-tool-choice --tool-call-parser hermes"
})


vllm_qwen2d5_128k_engine064 = VllmEngine(**{
            **vllm_engine064.model_dump(),
            "model_files_modify_hook": "dmaa.models.utils.model_files_modify_hooks.qwen2d5_128k_model_files_hook",
            "default_cli_args": " --chat-template dmaa/models/chat_templates/qwen_2d5_add_prefill_chat_template.jinja --gpu-memory-utilization 0.95 --max_model_len 120000 --max_num_seq 1 --disable-log-stats --enable-auto-tool-choice --tool-call-parser hermes"
})
...
vllm_qwen2vl7b_engine064 = VllmEngine(**{
            ...
            "default_cli_args": " --chat-template dmaa/models/chat_templates/qwen2vl_add_prefill_chat_template.jinja --max_model_len 16000 --disable-log-stats --limit-mm-per-prompt image=2,video=1 --max_num_seq 1 --gpu_memory_utilization 0.9"
})
vllm_qwen2vl72b_engine064 = VllmEngine(**{
             **vllm_engine064.model_dump(),
            "environment_variables": "export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True",
            "default_cli_args": " --chat-template dmaa/models/chat_templates/qwen2vl_add_prefill_chat_template.jinja --max_model_len 25000 --disable-log-stats --limit-mm-per-prompt image=20,video=1 --max_num_seq 1 --gpu_memory_utilization 0.9"
})

vllm_internvl2d5_76b_engine064 = VllmEngine(**{
             **vllm_engine064.model_dump(),
            "environment_variables": "export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True",
            "default_cli_args": " --chat-template dmaa/models/chat_templates/qwen2vl_add_prefill_chat_template.jinja --max_model_len 8192 --disable-log-stats --limit-mm-per-prompt image=5,video=1 --max_num_seq 1 --gpu_memory_utilization 0.9"
})
...
vllm_internlm2d5_engine064 = VllmEngine(
    **{
            **vllm_engine064.model_dump(),
            "default_cli_args": " --chat-template dmaa/models/chat_templates/internlm2d5_add_prefill_chat_template.jinja --max_model_len 16000 --disable-log-stats --enable-auto-tool-choice --tool-call-parser internlm"
    }
)
...
tgi_llama3d3_engine301 = TgiEngine(
    **{
        ...
        "use_public_ecr":True,
        "docker_login_region":"us-east-1",
        "model_files_modify_hook":"dmaa.models.utils.model_files_modify_hooks.replace_chat_template_hook",
        "model_files_modify_hook_kwargs":{"chat_template":"dmaa/models/chat_templates/llama3d3_add_prefill_chat_templates.jinja"},
...
tgi_qwen2d5_72b_engine064 = TgiEngine(
    **{
        ...
        "docker_login_region":"us-east-1",
        "model_files_modify_hook":"dmaa.models.utils.model_files_modify_hooks.replace_chat_template_hook",
        "model_files_modify_hook_kwargs": {"chat_template":"dmaa/models/chat_templates/qwen_2d5_add_prefill_chat_template.jinja"},
        "default_cli_args": " --max-total-tokens 16000 --max-concurrent-requests 10",
    }
)
